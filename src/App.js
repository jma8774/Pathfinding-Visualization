...
function App() {
  ...
  const [message, setMessage] = useState('Hello there, welcome to the pathfinding visualizer! Press the question mark for instructions on how to add/delete grids.')
